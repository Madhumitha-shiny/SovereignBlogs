    ...
    <div class="container-fluid">
        <div class="row">
            <div style="background-color:lightgrey" class="col-lg-3 col-mb-12 py-3">
                ...
                <div class="row p-2 m-2">
                    <a class="btn btn-warning" href="editabout.php?edit=0">Edit About</a>
                </div>
                <div class="row p-2 m-2">
            ...
            <div class="col m-4">
                <form method="POST" action="abedit.php">
                    <div style="border: 3px dashed blue;" class="row p-2 m-2 card">
                        <h1>MISSION STATEMENT</h1>

                        <?php if ($edit == 1) { ?>
                            <textarea name="mission" id="mission" cols="30" rows="10"><?php echo $d2['mission'] ?>
                        </textarea>
                            <div class="m-2">
                                <input class="btn btn-success" type="submit" value="SUBMIT"></a>
                                <a href="editabout.php?edit=0" class="btn btn-warning">GO BACK</a>
                            </div>

                        <?php } elseif ($edit == 0) { ?>
                            <div>
                                <?php echo $d2['mission'] ?>
                                <a href="editabout.php?edit=1" class="btn btn-primary">Edit</a>
                            </div>
                        <?php } ?>
                    </div>
                    <div style="border: 3px dashed purple;" class="row p-2 m-2 card">
                        ...
                        <?php if ($edit == 1) { ?>
                            <textarea name="vision" id="vision" cols="30" rows="10"><?php echo $d2['vision']; ?></textarea>
                            <div class="m-2">
                                <input class="btn btn-success" type="submit" value="SUBMIT"></a>
                                <a href="editabout.php?edit=0" class="btn btn-warning">GO BACK</a>
                            </div>
                    ...
                    <div style="border: 3px dashed orange;" class="row p-2 m-2 card">
                        <h1>BREIF COMPANY HISTORY</h1>
                        <?php if ($edit == 1) { ?>
                            <textarea name="history" id="history" cols="30" rows="10"><?php echo $d2['history']; ?></textarea>
                            <div class="m-2">
                                <input class="btn btn-success" type="submit" value="SUBMIT"></a>
                                <a href="editabout.php?edit=0" class="btn btn-warning">GO BACK</a>
                            <?php } elseif ($edit == 0) { ?>
