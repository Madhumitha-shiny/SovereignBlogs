<div class="container-fluid shadow">
    <div class="row p-3">
        ...
        ?>
            ...
            <div class="col-lg-auto col-md-12 pt-2">
            ...
            <div style="float: right;" class="col-lg-auto col-md-12 pt-2">
        ...
        ?>
            ...
            <div class="col-lg-2 col-md-12 pt-2">
                <a href="logout.php" class="btn btn-danger">LOGOUT</a>
            </div>
            <div class="col-lg-auto m-1 col-md-12 btn btn-light shadow">
